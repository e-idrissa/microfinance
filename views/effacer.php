...
<body>
    <?php
        ...
        include_once '../controllers/deleteCompte.php';
    ?>
    <div class="p-10 px-48 w-full">
        ...
        <div class="flex flex-col px-48 mx-12 justify-center w-full mt-24">
            <span class="text-2xl font-bold text-gray-700 text-center">Supprimer un Compte</span>
            <form action="../controllers/deleteCompte.php" method="post">
                <div class="flex flex-col items-center justify-center mt-8 space-y-2">
                    <div class="flex items-center justify-center w-2/3 space-x-8">
                        <div class="flex flex-col space-y-2 w-1/2">
                            <label for="compte" class="text-lg text-gray-700">Compte</label>
                            <select name="id" id="id" class="bg-gray-200 p-2 rounded" required>
                    ...
                    <div class="flex items-center justify-center mt-2 w-2/3">
