...
<body>
    ...
    <div class="p-10 px-48 w-full">
        ...
        <div class="flex flex-col px-48 mx-12 justify-center w-full mt-24">
            <span class="text-2xl font-bold text-gray-700 text-center">Effectuer un Retrait</span>
            <form action="../controllers/retrait.php" method="post">
                <div class="flex flex-col items-center justify-center mt-8 space-y-2">
                    <div class="flex items-center w-2/3 space-x-8">
                        ...
                        <div class="flex flex-col space-y-2 w-full">
                            ...
                            <input type="number" name="montant" id="montant" placeholder="200" min="200" class="bg-gray-200 p-2 rounded" required>
                        </div>
                    </div>
                    <input type="hidden" name="op" value="retrait" required>
